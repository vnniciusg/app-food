        ...
        <View className="w-full h-screen px-10 py-20 mt-4 rounded-3xl border-3 ">
            ...
            <Text className="font-medium text-lg text-color2 mt-4 text-center ">{subtitle}</Text>
                <View className="mt-2 flex flex-col">
                    <Label name="Nome" iconName=''  placeholder="Digite seu Nome: "/>
                    <Label name="Email" iconName='' placeholder="Digite seu E-mail: " />
                    <Label name="Senha" iconName=''  placeholder="Digite sua senha: "/>
                    <Label name="Confirmar Senha" iconName=''  placeholder="Confirme sua senha: "/> 
                    <View className="flex flex-row gap-x-6 mb-5">
                        <View className="flex-1">
                            <Label name="Altura" iconName='' placeholder="Informe sua altura"/>
                        </View>
                        <View className="flex-1">
                            <Label name="Peso" iconName='' placeholder="Informe seu Peso" />
                        </View>
                    </View>
                <View>
