			...
			<View className="px-[30px] mb-2 h-auto">
				<View className="flex flex-col mt-[15px] items-center">
					...
					<View className="flex flex-col justify-center items-center">
						<Title className="text-base font-bold mt-[15px] mb-[5px] text-color4">John Doe</Title>
			...
			<View className="mt-[20px]">
				...
				>
					<View className="flex flex-row my-3 px-1">
						...
						<Text className="ml-[20px] font-medium text-sm text-black">Edite seu perfil</Text>
					</View>
				</TouchableRipple>
				<TouchableRipple onPress={() => {}}>
					<View className="flex flex-row my-3 px-1">
						<Icon name="share-outline" color="#146C94" size={25} />
						<Text className="ml-[20px] font-medium text-sm text-black">Compartilhar com seus amigos</Text>
					</View>
				</TouchableRipple>
				<TouchableRipple onPress={logout}>
					<View className="flex flex-row my-3 px-1">
						<Icon name="logout" color="#146C94" size={25} />
						<Text className="ml-[20px] font-medium text-sm text-black">Logout</Text>
					</View>
				</TouchableRipple>
			</View>
			<ProfileModal visible={showModal} onClose={() => setShowModal(false)} title="TITULO" labelValue="ASDASDASD" />
		</SafeAreaView>
	);
};
